...
export const projects: ProjectItem[] = [
  ...
  },
  {
    ...
    title: "SmartLedger",
    shortDesc:
      "Founder project — end-to-end product design and full-stack build for a petrol bunk ERP; live demo on Vercel",
    featured: true,
    duration: "Nov 2023 – Dec 2024",
    link: "https://smart-ledger-six.vercel.app",
    linkLabel: "Live demo",
    devBullets: [
      "Founded and built a full-stack ERP for petrol bunk management — inventory, billing, and Tally integration — replacing fragmented manual workflows for day-to-day operations.",
      "Actively used across multiple petrol bunks daily — driving real operator productivity in production.",
      ...
      "Integrated MSW (Mock Service Worker) for demo-mode API simulation — so portfolio viewers can explore the full product experience without a live backend.",
    ],
    designBullets: [
      "Founder-led product design — end-to-end UI for a petrol bunk ERP: inventory, billing, and workflow screens built for non-technical daily operators.",
      "Created reusable Figma component library and layout system used throughout the product.",
      "Aligned UX with a live interactive demo so operators could validate real flows early — iterated over 12 months of active use.",
    ],
    devTech: ["React", "Tailwind CSS", "MSW", "PostgreSQL", "Vercel"],
    designTools: ["Figma", "Component Library", "User Research"],
    tags: ["Founder", "Full-stack", "ERP", "Real Users"],
    designTags: ["Founder", "UI/UX", "Figma", "Product Design"],
    gradient: {
      from: "#7c3aed",
      via: "#4f46e5",
      to: "#06b6d4",
