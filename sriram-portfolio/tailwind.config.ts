...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        // Glass shadows
        "glass-sm":    "0 2px 8px rgba(0,0,0,0.3), inset 0 0 0 1px rgba(255,255,255,0.06)",
        "glass":       "0 4px 24px rgba(0,0,0,0.4), inset 0 0 0 1px rgba(255,255,255,0.08)",
        "glass-lg":    "0 8px 40px rgba(0,0,0,0.5), inset 0 0 0 1px rgba(255,255,255,0.10)",
        "glass-purple":"0 4px 24px rgba(124,58,237,0.3), inset 0 0 0 1px rgba(124,58,237,0.2)",
        "glass-cyan":  "0 4px 24px rgba(6,182,212,0.3),  inset 0 0 0 1px rgba(6,182,212,0.2)",
        // Brutalist shadows
      ...
      backgroundImage: {
        ...
        "gradient-dev-soft":  "linear-gradient(135deg, rgba(124,58,237,0.15) 0%, rgba(6,182,212,0.15) 100%)",
        "gradient-dark":      "linear-gradient(180deg, #0a0a0f 0%, #13131a 100%)",
        // Gradients — designer
        "gradient-design":    "linear-gradient(135deg, #39FF14 0%, #84cc16 100%)",
        "gradient-design-soft":"linear-gradient(135deg, rgba(57,255,20,0.15) 0%, rgba(132,204,22,0.15) 100%)",
        // Shimmer
        "shimmer":            "linear-gradient(90deg, transparent 0%, rgba(255,255,255,0.05) 50%, transparent 100%)",
        "shimmer-green":      "linear-gradient(90deg, transparent 0%, rgba(57,255,20,0.08) 50%, transparent 100%)",
      },
      ...
      keyframes: {
        ...
        "glow-pulse-green": {
          "0%, 100%": { opacity: "1",   boxShadow: "0 0 20px rgba(57,255,20,0.4)" },
